...
const fetchHeroes = async () => {
    try {
        ...
        heroes.value = data.map((hero: Hero): Hero => ({
            id: hero.id,
            ...
            img: `/apps/dota2/images/dota_react/heroes/${hero.localized_name}.png?`, // Path to the hero's image (assuming the image name is the internal 'name')
            primary_attr: hero.primary_attr, // Mapping primary_attr from API response
